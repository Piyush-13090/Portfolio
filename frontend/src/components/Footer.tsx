...
const socialLinks = [
  { icon: Github, href: 'https://github.com/Piyush-13090', label: 'GitHub', color: 'hover:bg-zinc-700' },
  { icon: Linkedin, href: 'https://www.linkedin.com/in/piyush-sharma-5a8490306/', label: 'LinkedIn', color: 'hover:bg-blue-600' },
  { icon: ExternalLink, href: '#home', label: 'Back to Top', color: 'hover:bg-green-600' },
  { icon: Mail, href: 'mailto:sharma.piyush2024@nst.rishihood.edu.in', label: 'Email', color: 'hover:bg-red-600' },
];
        ...
        <div className="container mx-auto px-6 pt-16 pb-8">
              ...
              <div className="flex gap-3 mt-6">
                {socialLinks.map((social, idx) => (
                  <motion.a
                    ...
                    rel={social.href.startsWith('mailto:') || social.href.startsWith('#') ? undefined : 'noopener noreferrer'}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            >
              ...
              by <span className="text-white font-medium">Piyush Sharma</span>
            </motion.p>
